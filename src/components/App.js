...
// Import ABI + Config
import OpenPunks from '../abis/Cryptilians.json'
...
function App() {
	...
	const mintNFTHandler = async () => {
		...
		if (openPunks && account) {
			...
			await openPunks.methods.mint(1).send({ from: account, value: 2500000000000000000 })
			...
			<main>
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						<Col xs={12} md={12} lg={8} xxl={8}>
							<h1>Cryptilian</h1>
							<p className='sub-header'>Drop at: 02 / 19 / 22</p>
						</Col>
						<Col className='flex social-icons'>
							<a
								href="https://twitter.com/Vill_Vegas"
								target='_blank'
								className='circle flex button'>
								<img src={twitter} alt="Twitter" />
							</a>
							<a
								href="https://www.instagram.com/nugget.land"
																target='_blank'
								className='circle flex button'>
					...
					<Row className='flex m-3'>
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img
								src={`https://gateway.pinata.cloud/ipfs/QmXZ7LveRTfTgVaC8AsZLf13ZVBnaTeyYFY1fzxvbHSzQx/${counter}.png`}
								alt="Cryptilian"
								className='showcase'
							/>
						</Col>
						<Col md={5} lg={4} xl={5} xxl={4}>
							...
							<p className='text'>
								"Cryptilians by @Queen.Skittles its a collab collection between @Bahidora Festival and @Nugget.land. Infuenced by abstract modernism the artist portrays totemized guardians from her bubblegum pop world!"
							</p>
				...
				<section id='about' className='about'>
					...
					<Row className='flex m-3'>
						...
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img src={showcase} alt="Multiple Cryptilians" className='showcase' />
						</Col>
						<Col md={5} lg={4} xl={5} xxl={4}>
							{isError ? (
								<p>{message}</p>
								...
								<div>
									...
									<ul>
										<li>"Cryptilians by @Queen.Skittles its a collab collection between @Bahidora Festival and @Nugget.land.</li>
										<li>Infuenced by abstract modernism the artist portrays totemized guardians</li>
										<li>from her bubblegum pop world!</li>
									</ul>
